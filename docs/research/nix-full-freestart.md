...
Related: `docs/research/free-start-handoff.md` (§0 convex-floor fix, this session), `docs/research/free-start-position-plan.md` (Phase 4 = multi-jump single-translation), memory `project_nix_multijump_freestart` + `project_free_start_position`.
