...
import de.legoshi.parkourcalc.forge12.sim.paired.PairedCheckpoint;
import de.legoshi.parkourcalc.forge12.sim.paired.PairedServerSim;
...
public final class Forge12Simulator extends LazyEntitySimulator<SimulatorEntity> {
    ...
    private void ensurePair(SimulatorEntity e) {
        ...
        if (pair != null && pair.level() != e.world) {
            pair.shutdown();
            pair = null;
        }
        if (pair == null) {
