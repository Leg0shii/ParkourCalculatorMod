...
public class CustomBudgetTest {
    ...
    public void stateResetClearsEffortAndBudget() {
        ...
        s.getSolveBudget().setTimeBudgetSeconds(120);
        s.reset();
        assertEquals(AngleSolverState.Effort.FAST, s.getEffort());
        assertEquals(0, s.getSolveBudget().getTimeBudgetSeconds());
    }
    ...
    public void zeroTimeBudgetSurvivesRoundTrip() throws Exception {
        ...
        AngleSolverState loaded = roundTrip(s);
        assertEquals(12, loaded.getSolveBudget().getWindow());
    ...
    public void absentGraphPresetFieldLoadsAsLegacyCustom() {
        String json = "{\n" +
                ...
                "      \"polishCount\": 2, \"timeBudgetSeconds\": 25, \"window\": 10, \"commit\": 3 } }\n" +
                "}";
        ...
        assertEquals(25, s.getSolveBudget().getTimeBudgetSeconds());
    }
