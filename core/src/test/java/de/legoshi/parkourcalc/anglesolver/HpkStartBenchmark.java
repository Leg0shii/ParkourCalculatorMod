...
public class HpkStartBenchmark {
    ...
    static {
        ...
        add("d11", "j716-1bm_Cobblewall_to_Cobblewall_Winged_Neo", false, -699.9501960734942, true);
    ...
    public void benchmark() {
        ...
        p("%n=== HPK START BENCHMARK  effort=%s optSec=%d timeout=%dms ===%n",
                effortName, optSec, timeoutMs);
        ...
        for (Object[] row : CORPUS) {
            ...
            SolveResult r = solveCold(file, effort, optSec, timeoutMs);
